...
labeldir='/DATA/239/dywu/brainnetome_atlas/BN_Atlas_freesurfer_v6.0/fsaverage/fsaverage_LR32k'
roidir=$scriptroot/ROI_surf210

roilist=`cat /DATA/239/dywu/brainnetome_atlas/BN_Atlas_freesurfer_v6.0/BN210_labelname_surface.txt`
roilist_L=`cat /DATA/239/dywu/brainnetome_atlas/BN_Atlas_freesurfer_v6.0/BN210_labelname_surface_L.txt`
roilist_R=`cat /DATA/239/dywu/brainnetome_atlas/BN_Atlas_freesurfer_v6.0/BN210_labelname_surface_R.txt`
...
#for sub in $sublist; do
	...
	for roi in $roilist_L; do
		roiname=`printf "%03d\n" $i`
		wb_command -gifti-label-to-roi 	$labeldir/fsaverage.L.BN_Atlas.32k_fs_LR.label.gii $subdir/$sub/MNINonLinear/$ROI/${roiname}.func.gii  -name ${roi}
		...
		wb_command -cifti-separate $subdir/$sub/MNINonLinear/$ROI/${roiname}.dscalar.nii COLUMN -metric CORTEX_LEFT $subdir/$sub/MNINonLinear/$ROI/${roiname}.func.gii
...
#for sub in $sublist; do
	...
	for roi in $roilist_R; do
		roiname=`printf "%03d\n" $i`
		wb_command -gifti-label-to-roi 	$labeldir/fsaverage.R.BN_Atlas.32k_fs_LR.label.gii $subdir/$sub/MNINonLinear/$ROI/${roiname}.func.gii  -name ${roi}
		...
		wb_command -cifti-separate $subdir/$sub/MNINonLinear/$ROI/${roiname}.dscalar.nii COLUMN -metric CORTEX_RIGHT $subdir/$sub/MNINonLinear/$ROI/${roiname}.func.gii

...
#for sub in $sublist; do
	...
	#	roiname=$roi   #`printf "%03d\n" $i`
		...
		#surf2surf -i $subdir/$sub/MNINonLinear/fsaverage_LR32k/$sub.L.$surface.32k_fs_LR.surf.gii -o $subdir/$sub/MNINonLinear/$ROI/left.asc  --values=1 --outputtype=ASCII
		wb_command -surface-coordinates-to-metric $subdir/$sub/MNINonLinear/fsaverage_LR32k/$sub.L.$surface.32k_fs_LR.surf.gii $subdir/$sub/MNINonLinear/$ROI/left_coordinate.func.gii
...
#for sub in $sublist; do
	...
	#	wb_command -gifti-label-to-roi 	$labeldir/Q1-Q6_RelatedParcellation210.R.CorticalAreas_dil_Colors.32k_fs_LR.label.gii $subdir/$sub/MNINonLinear/$ROI/${roiname}.func.gii  -name ${roi}
		...
		#surf2surf -i $subdir/$sub/MNINonLinear/fsaverage_LR32k/$sub.R.$surface.32k_fs_LR.surf.gii  -o $subdir/$sub/MNINonLinear/$ROI/right.asc  --values=1  --outputtype=ASCII
		wb_command -surface-coordinates-to-metric $subdir/$sub/MNINonLinear/fsaverage_LR32k/$sub.R.$surface.32k_fs_LR.surf.gii $subdir/$sub/MNINonLinear/$ROI/right_coordinate.func.gii
